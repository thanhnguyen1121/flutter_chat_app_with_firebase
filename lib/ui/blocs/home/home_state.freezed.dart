...
mixin _$HomeState {
  ...
  TResult when<TResult extends Object?>(
    TResult Function(List<UserDto> users) $default, {
...
class _$HomeStateData implements HomeStateData {
  const _$HomeStateData(final List<UserDto> users) : _users = users;
...
abstract class HomeStateData implements HomeState {
  const factory HomeStateData(final List<UserDto> users) = _$HomeStateData;
